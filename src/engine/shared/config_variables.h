...
MACRO_CONFIG_INT(ClCursorScale, cl_cursor_scale, 100, 20, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Amount to scale the in game cursor by as a percentage (50 = half, 200 = double)")
