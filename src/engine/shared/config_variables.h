...
MACRO_CONFIG_INT(SvVoteKickMin, sv_vote_kick_min, 0, 0, SERVERINFO_MAX_CLIENTS, CFGFLAG_SERVER, "Minimum number of players required to start a kick vote")
...
// debug
MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 0, 0, SERVERINFO_MAX_CLIENTS, CFGFLAG_SERVER, "Add debug dummies to server (Debug build only)")
