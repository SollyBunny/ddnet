...
MACRO_CONFIG_INT(ClOverlayEntitiesTransition, cl_overlay_entities_transition, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Transition overlay entities, changes background behaviour")
